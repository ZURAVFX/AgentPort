...
<Border Grid.Row="3" Background="#0D1117" BorderBrush="#2B313B" BorderThickness="1" CornerRadius="14" Padding="16"><Grid><Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="*"/><RowDefinition Height="Auto"/></Grid.RowDefinitions><TextBlock Text="Connected tools" FontSize="15" FontWeight="SemiBold"/><ScrollViewer Grid.Row="1" Margin="0,10,0,10" VerticalScrollBarVisibility="Auto"><StackPanel x:Name="Servers"/></ScrollViewer><StackPanel Grid.Row="2"><CheckBox x:Name="Local" Content="Enable MCP tools in NInfer Tools profiles" Foreground="White"/><TextBlock Text="NInfer 24k Fast omits MCP schemas to stay responsive. Choose 32k Tools (recommended) or 49k Max to use ComfyUI or Blender." TextWrapping="Wrap" Foreground="#8A8A94" FontSize="11" Margin="0,5,0,0"/></StackPanel></Grid></Border>
